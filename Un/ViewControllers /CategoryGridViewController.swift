...
class CategoryGridViewController: UIViewController {
    ...
    private func loadCategoryImages() {
        print("📡 Загружаю: \(category)")
        loadingIndicator.startAnimating()
        
        UnsplashNetworkManager.shared.fetchImagesByCategory(category: category, perPage: 100) { [weak self] images, error in
